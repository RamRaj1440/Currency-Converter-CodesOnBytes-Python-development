...
root.title("Currency converter:CodesOnBytes")

Tops = Frame(root, bg = '#e6e5e5', pady=2, width=1850, height=100, relief="ridge")
Tops.grid(row=0, column=0)

headlabel = tk.Label(Tops, font=('lato black', 19, 'bold'), text='Currency converter :CodesOnBytes ',
					bg='#e6e5e5', fg='black')
...
root.mainloop()
# Currency-Converter-CodesOnBytes-Python-development
